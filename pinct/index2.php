...
<h2>Сброс пароля</h2>
<br>
<input type='text' id='passw-set' class='login-set' name='login-set' placeholder='Новый пароль' maxlength='50' />
<br><br>
<input type='text' id='passw2-set' class='email-set' name='email-set' placeholder='Повтор пароля' maxlength='50' />
<br><br>
