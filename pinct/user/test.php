...
<div align='center'>
<form align='center' name='form-register' action='handler.php' method='POST' id='form-register888' class='form-register'>
  
<input type='text' id='email-register888' class='email-register' name='email-register' placeholder='Адрес эл. почты' required='required' />
<br>
...
<a href='' class='refresh-reg' return='false'><div align='left' class='refresh-reg'></div></a>
 ...
 <input class='captcha-reg' type='text' name='captcha_code' value='' required='required' placeholder='Код с картинки' />
 <br>
<input type='submit' id='submit-register888' class='submit-register' name='submit-register' value='Хочу зарегистрироваться' />
 <br> 
 <div align='center'>
 <div class='checkboxes' style='width: 270px!important; margin-top: 11px!important;'>
<noindex>
<div align='center' class='check-active' id='input-check-reg' style='color: white; text-shadow: 1px 1px 2px #000000;'>Добавить друзей <a href='https://vk.com' rel='nofollow' target='_blank'>Вконтакте</a> и <a href='https://www.facebook.com' rel='nofollow' target='_blank'>Facebook</a>.</div>
</noindex>
</div>
</div>
...
$('div.center-register').delay(1200).animate({
'marginLeft': '0px'
}, 1300, 'easeOutElastic');
...
$("div.refresh-reg").click(function(){
event.preventDefault();
