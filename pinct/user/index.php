...
$('#pin117').delegate('#pinned117','mouseover',function(){
$('#action117').toggleClass('actionbar-hover', true);
      });
	  
$('#pin117').delegate('#pinned117','mouseleave',function(){
$('#action117').removeClass('actionbar-hover');
$('#pin-nav117').removeClass('navpin-show');
