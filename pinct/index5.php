...
<div align='center' id='this888' class='this-photo'><a target='_blank' href='http://pinct.ru/bigpins/<?php echo resViewPinView(); ?>' class='only-this-photo' id='only-this888'><img id='my-img888' class='this-img' src='http://pinct.ru/bigpins/<?php echo resViewPinView(); ?>' alt='<?php echo resViewPinName(); ?>' title='<?php echo resViewPinName(); ?>' align='bottom' /></a></div>
...
<?php dataProfile(resViewPinAutor(), false); ?>

<img class='view-autor' id='autor-bar888' src='http://pinct.ru/user/<?php echo resProfileThumb(); ?>' align='left' width='70px'/>
<div id='tooltip-menu-myrepin' class='navtooltip'>
 <img src='http://pinct.ru/img/tik-menu-top.png' align='left' width='17'/><?php echo resViewPinAutor(); ?>
</div>
</div></a>
...
<a target='_blank' href='http://pinct.ru/bigpins/<?php echo resViewPinView(); ?>' class='view-myzoom' id='click-myzoom888' return='false'><div align='center' id='zoom-bar888' class='zoom-view'>
<div id='tooltip-menu-myrepin' class='navtooltip'>
...
<?php dataPin("pin", "autor", resViewPinAutor(), "", false); ?>
...
<a href='' class='click-myview' id='second-view888' return='false'><img alt='<?php echo resPinName($c); ?>' title='<?php echo resPinName($c); ?>' class='view-pict' id='autor-pict888' src='http://pinct.ru/tag/<?php echo resPinTagThumb($c); ?>' align='left' width='89px'/></a>
</div>
...
<?php nameBoard(resViewPinBoard(), false); ?>

<div align='left' id='board-bar888' class='board-autor'>
<a href='http://pinct.ru/boards/<?php echo nameBoardPath(); ?>' return='false'>
<img alt='<?php echo nameBoardName(); ?>' title='<?php echo nameBoardName(); ?>' class='board-autor' id='board-bar888' src='http://pinct.ru/boards/<?php echo nameBoardThumb(); ?>' align='left' width='70px' height='70px'/></a>
<br>
Ещё посты из альбома 
<a href='http://pinct.ru/boards/<?php echo nameBoardPath(); ?>' class='board-link' id='board-noview888' return='false'>"<?php echo nameBoardName(); ?>"</a>
</div>

<?php dataPin("pin", "board", nameBoardName(), "", false); 
$rowsBoardView23 == 15;
?>
...
<a href='http://pinct.ru/tag/<?php echo resPinTagThumb($c); ?>' class='board-click-myview' id='board-second-view888' return='false'><img alt='<?php echo resPinName($g); ?>' title='<?php echo resPinName($g); ?>' class='board-view-pict' id='board-autor-pict888' src='http://pinct.ru/tag/<?php echo resPinTagThumb($g); ?>' align='left' width='89px'/></a>
</div>
...
// перезагрузка страницы настроек
elseif ($url1 == 'settings'){
