...
<div align='right' class='eye'>
<div align='right' class='eye-close'></div>
<div align='right' class='eye-open'></div>
</div>

<input type='password' id='pass-auth' class='pass-auth-passw' name='pass-auth' placeholder='Пароль' maxlength='30' />
<input type='text' id='pass-auth' class='pass-auth-hide' name='pass-auth2' placeholder='Посмотреть пароль :)' maxlength='30' />
<br>
...
$('div.form-auth').delegate('input.submit-auth','mouseover',function(){
$('input.submit-auth').toggleClass('submit-auth-hover', true);

});
   
$('div.form-auth').delegate('input.submit-auth','mouseleave',function(){
...
inputPassw1 = $('input#pass-auth');
passwText1 = $('input#pass-auth').attr('value');
patternPassw1 = /^[a-zA-Z0-9]+$/i;
matchPassw1 =  passwText1.match(patternPassw1);
...
$('input.pass-auth-passw').css('color','#e74c3c');
$('input.pass-auth-hide').css('color','#e74c3c');
$('div#error-auth-pass').html("<img src='http://pinct.ru/img/tik-error-left.png' align='left' width='17'/>не&nbsp;менее&nbsp;6&nbsp;символов!");
$('div#error-auth-pass').css('display','block');
if (emailText1.length >= 8) {
if (matchEmail1) {
if (captchaText1.length == 4) {
if (matchCaptcha1) {
...
$('input.pass-auth-passw').css('color','#e74c3c');
$('input.pass-auth-hide').css('color','#e74c3c');
$('div#error-auth-pass').html("<img src='http://pinct.ru/img/tik-error-left.png' align='left' width='17'/>Только&nbsp;числа&nbsp;и&nbsp;латиница!");
$('div#error-auth-pass').css('display','block');
$('input.submit-auth').toggleClass('submit-auth-hold', true);
$('input.submit-auth').css('cursor','default');
...
$('input.pass-auth-passw').css('color','#000000');
$('input.pass-auth-hide').css('color','#000000');
$('div#error-auth-pass').css('display','none');	
if (emailText1.length >= 8) {
if (matchEmail1) {
if (captchaText1.length == 4) {
if (matchCaptcha1) {
...
if ((emailText1 == '') || (passwText1 == '') || (captchaText1 == '') || (!matchEmail1) || (!matchPassw1) || (!matchCaptcha1) || (captchaText1.length < 4) || (passwText1.length < 6) || (emailText1.length < 8)) {
...
$('input#pass-auth').keyup(function(){
inputPassw = $(this);
passwText = $(this).attr('value');
patternPassw = /^[a-zA-Z0-9]+$/i;
matchPassw =  passwText.match(patternPassw);
...
$('input.pass-auth-passw').css('color','#e74c3c');	
$('input.pass-auth-hide').css('color','#e74c3c');	
$('div#error-auth-pass').html("<img src='http://pinct.ru/img/tik-error-left.png' align='left' width='17'/>Заполните&nbsp;поле!");
$('div#error-auth-pass').css('display','block');
$('input.submit-auth').toggleClass('submit-auth-hold', true);
$('input.submit-auth').css('cursor','default');
...
inputPassw2 = $('input#pass-auth');
passwText2 = $('input#pass-auth').attr('value');
patternPassw2 = /^[a-zA-Z0-9]+$/i;
matchPassw2 =  passwText2.match(patternPassw2);
...
if ((emailText2 == '') || (passwText2 == '')  || (captchaText2 == '') || (!matchEmail2) || (!matchPassw2) ||  (!matchCaptcha2) || (captchaText2.length < 4) || (passwText2.length < 6) || (emailText2.length < 8)) {
...
$('input.pass-auth-passw').change(function(){

newPassw = $(this).attr('value');
$('input.pass-auth-hide').attr('value',newPassw);
	
});

$('input.pass-auth-hide').change(function(){

newHide = $(this).attr('value');
$('input.pass-auth-passw').attr('value',newHide);
	
});

$('div.form-auth').delegate('div.eye','mouseover',function(){
$('div.eye-open').toggleClass('eye-open-hover', true);
$('div.eye-close').toggleClass('eye-close-hover', true);
});

$('div.form-auth').delegate('div.eye','mouseleave',function(){
$('div.eye-open').toggleClass('eye-open-hover', false);
$('div.eye-close').toggleClass('eye-close-hover', false);
});

$('div.form-auth').delegate('div.eye-open','click',function(){
$('input.pass-auth-hide').css('display','none');
$('input.pass-auth-passw').css('display','inline').focus();
$('div.eye-open').css('display','none');
$('div.eye-close').css('display','inline-block');
});

$('div.form-auth').delegate('div.eye-close','click',function(){
$('input.pass-auth-passw').css('display','none');
$('input.pass-auth-hide').css('display','inline').focus();
$('div.eye-open').css('display','inline-block');
$('div.eye-close').css('display','none');
});
