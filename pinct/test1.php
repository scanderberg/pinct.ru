...
<input type='submit' id='submit-register888' class='submit-register' name='submit-register' value='Хочу зарегистрироваться' />
 <br> 
 <div align='center'>
 <div class='checkboxes' style='width: 200px!important; margin-top: 11px!important;'>
<div align='center' class='check active' id='input-check-reg' style='color: white; text-shadow: 1px 1px 2px #000000;'>Добавить друзей Вконтакте.</div>
</div>
</div>
