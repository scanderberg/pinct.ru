...
?>
Коллекции пользователя <?php if (resProfileName()){ if (resProfileSoname()){ echo resProfileName() . " " . resProfileSoname(); }} else { echo resProfileUsers(); } ?> | Pinct
<?php
...
?>
То, что понравилось пользователю <?php if (resProfileName()){ if (resProfileSoname()){ echo resProfileName() . " " . resProfileSoname(); }} else { echo resProfileUsers(); } ?> | Pinct
<?php

}
else {
?>
Страница не найдена / Not Found 404 | Pinct
<?php
}
...
?>
Подписчики пользователя <?php if (resProfileName()){ if (resProfileSoname()){ echo resProfileName() . " " . resProfileSoname(); }} else { echo resProfileUsers(); } ?> | Pinct
<?php
...
?>
Пользователи, за которыми следует <?php if (resProfileName()){ if (resProfileSoname()){ echo resProfileName() . " " . resProfileSoname(); }} else { echo resProfileUsers(); } ?> | Pinct
<?php
...
?>
Репосты пользователя <?php if (resProfileName()){ if (resProfileSoname()){ echo resProfileName() . " " . resProfileSoname(); }} else { echo resProfileUsers(); } ?> | Pinct
<?php
...
if (resProfileUsers()){
?>
Пользователь <?php if (resProfileName()){ if (resProfileSoname()){ echo resProfileName() . " " . resProfileSoname(); }} else { echo resProfileUsers(); } ?> | Pinct
<?php
}
else {
?>
...
if (resMyBoardsId()){
?>
<?php echo resMyBoardsName(0); ?> - Коллекция пользователя <?php echo resMyBoardsUsers(0); ?> | Pinct
<?php
}
else {
?>
...
?>
Pinct | Коллекции и идеи со всего мира
<?php
...
if (resCategoryId()){
?>
<?php echo resCategoryName(); ?> | Pinct
<?php
}
...
if (resGetTagsId(0)){
?>
Хеш-тэг #<?php echo resGetTagsName(0); ?> | Pinct
<?php
}
