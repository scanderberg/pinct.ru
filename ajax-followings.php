...
document.title = "Пользователи, за которыми следует <?php if (resProfileName()){ if (resProfileSoname()){ echo resProfileName() . " " . resProfileSoname(); }} else { echo resProfileUsers(); } ?> | Pinct";
