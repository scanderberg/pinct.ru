...
account={
   ...
   noClass4:'top-plus-nav-show',//12 сделать по-одному
   trNav:'img.tr-nav',//12 сделать по-одному
   trNav2:'img.tr-nav2',//12 сделать по-одному
...
$(par2).removeClass(par4);
  ...
  function topAnimAccount(par1,par2,par3,par4,par5,par6){

  $(par1).mouseover(function(){

$(par1).toggleClass(par3);
$(par2).toggleClass(par4);
$(par5).css('display','inline-block');
$(par6).css('display','none');
...
$(par1).removeClass(par3);
$(par2).removeClass(par4);
$(par5).css('display','none');
$(par6).css('display','inline-block');
  ...
  topAnimAccount(account.navElem, account.Nav, account.Hover, account.NavShow, account.trNav2, account.trNav);
