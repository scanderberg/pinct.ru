...
$(document).ready(function(){
 ...
 var $container = $('#pin-area');
    $container.masonry({
// элемент-контейнер в котором расположены блоки для динамической верстки
      itemSelector: 'section.pin',
// класс элемента являющегося блоком в нашей сетке
          singleMode: true,
...
// перестраивает блоки при изменении размеров окна
	  ...
	  isFitWidth: true,
// по центру с фиксированной шириной колонки
          animationOptions: { 
          queue: false, 
          duration: 500 
      }
