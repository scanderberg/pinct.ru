...
$('a#pin-view<?php echo $scroll2; ?><?php echo $numPin2; ?> <?php if($resPinType2 === "image") { ?>img#img<?php echo $numPin2; ?><?php } else { ?>iframe#video<?php echo $numPin2; ?><?php } ?>').fadeIn(1000, 'easeInExpo', function(){ 
...
$('a#pin-view<?php echo $scroll2; ?><?php echo $numPin2; ?>').html("<?php if($resPinType2 === 'image') { ?><img class='sectionpin' id='img<?php echo $numPin2; ?>' style='display: none;' src='http://pinct.ru/pins/<?php echo $dmgPin2; ?>'/><?php } else { ?><iframe class='sectionpin' id='video<?php echo $numPin2; ?>' style='border-radius: 5px 5px 0px 0px; -webkit-border-radius: 5px 5px 0px 0px; -moz-border-radius: 5px 5px 0px 0px;' width='200' height='130' src='<?php echo $resPinSource2; ?>' frameborder='0' allowfullscreen></iframe><?php } ?>");
