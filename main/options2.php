...
function myPin2($numPin2, $dmgPin2, $scroll2, $repinsPin2, $likesPin2, $commentsPin2, $commentsId2, $autorPin2, $autorThumbPin2){
...
$('#pin<?php echo $numPin2; ?>').fadeIn(2000);
