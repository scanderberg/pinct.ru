...
myPin2(resPinId($ux), resPinThumb($ux), $_GET['scroll'], resPinRepins($ux), resPinLikes($ux), resPinComments($ux), resPinCommentsId($ux), resPinAutor($ux), resPinAutorThumb($ux), resPinType($ux), resPinSource($ux));
