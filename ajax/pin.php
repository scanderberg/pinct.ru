...
<div align='center' id='pinned<?php echo resPinId($q); ?>' class='sectionpin'>
<div align='center' id='img<?php echo resPinId($q); ?>' class='imgpin' style='<?php if(resPinType($q) === "image") { ?>height: <?php echo resPinMinheight($q); ?>px; <?php } ?>background-color: <?php echo randColor(); ?>;'>
