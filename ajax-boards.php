...
<a class='myauthor' href='http://pinct.ru/board/<?php echo resBoardsPath($q); ?>' return='false'><img class='sectionboard' src='http://pinct.ru/boards/<?php echo resBoardsThumb($q); ?>' align='bottom' width='249px' alt='user'/></a>
<div align='center' id='board-name<?php echo resBoardsId($q); ?>' class='nameboard'>
<div align='center'>
<?php echo resBoardsName($q); ?>
</div>
</div>
<a class='myauthor' href='http://pinct.ru/board/<?php echo resBoardsPath($q); ?>' return='false'><img class='pictboard' src='http://pinct.ru/tag/<?php if (resPinTagThumb(1)) {echo resPinTagThumb(1); } else { echo "default.png"; } ?>' align='bottom' width='59px' alt='user'/></a>

<a class='myauthor' href='http://pinct.ru/board/<?php echo resBoardsPath($q); ?>' return='false'><img class='pictboard' src='http://pinct.ru/tag/<?php if (resPinTagThumb(2)) {echo resPinTagThumb(2); } else { echo "default.png"; } ?>' align='bottom' width='59px' alt='user'/></a>

<a class='myauthor' href='http://pinct.ru/board/<?php echo resBoardsPath($q); ?>' return='false'><img class='pictboard' src='http://pinct.ru/tag/<?php if (resPinTagThumb(3)) {echo resPinTagThumb(3); } else { echo "default.png"; } ?>' align='bottom' width='59px' alt='user'/></a>

<a class='myauthor' href='http://pinct.ru/board/<?php echo resBoardsPath($q); ?>' return='false'><img class='lastboard'  src='http://pinct.ru/tag/<?php if (resPinTagThumb(4)) {echo resPinTagThumb(4); } else { echo "default.png"; } ?>' align='bottom' width='59px' alt='user'/></a>
...
document.title = "Коллекции пользователя <?php if (resProfileName()){ if (resProfileSoname()){ echo resProfileName() . " " . resProfileSoname(); }} else { echo resProfileUsers(); } ?> | Pinct";
