...
// Generated б№ 22. џэт 09:47:15 2014
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._up__img.setAttribute('src','images/up.png');
		...
		this._up.onmouseover=function () {
			me._up__img.src='images/up__o.png';
		}
		this._up.onmouseout=function () {
			me._up__img.src='images/up.png';
		...
		this._down__img.setAttribute('src','images/down.png');
		...
		this._down.onmouseover=function () {
			me._down__img.src='images/down__o.png';
		}
		this._down.onmouseout=function () {
			me._down__img.src='images/down.png';
		...
		this._left__img.setAttribute('src','images/left.png');
		this._left__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._left__img['ondragstart']=function() { return false; };
		this._left.appendChild(this._left__img);
		this._left.onmouseover=function () {
			me._left__img.src='images/left__o.png';
		}
		this._left.onmouseout=function () {
			me._left__img.src='images/left.png';
		...
		this._right__img.setAttribute('src','images/right.png');
		this._right__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._right__img['ondragstart']=function() { return false; };
		this._right.appendChild(this._right__img);
		this._right.onmouseover=function () {
			me._right__img.src='images/right__o.png';
		}
		this._right.onmouseout=function () {
			me._right__img.src='images/right.png';
		...
		this._zoomin__img.setAttribute('src','images/zoomin.png');
		this._zoomin__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._zoomin__img['ondragstart']=function() { return false; };
		this._zoomin.appendChild(this._zoomin__img);
		this._zoomin.onmouseover=function () {
			me._zoomin__img.src='images/zoomin__o.png';
		}
		this._zoomin.onmouseout=function () {
			me._zoomin__img.src='images/zoomin.png';
		...
		this._zoomout__img.setAttribute('src','images/zoomout.png');
		this._zoomout__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 32px;height: 32px;-webkit-user-drag:none;');
		this._zoomout__img['ondragstart']=function() { return false; };
		this._zoomout.appendChild(this._zoomout__img);
		this._zoomout.onmouseover=function () {
			me._zoomout__img.src='images/zoomout__o.png';
		}
		this._zoomout.onmouseout=function () {
			me._zoomout__img.src='images/zoomout.png';
		...
		this._autorotate__img.setAttribute('src','images/autorotate.png');
		...
		this._autorotate.onmouseover=function () {
			me._autorotate__img.src='images/autorotate__o.png';
		}
		this._autorotate.onmouseout=function () {
			me._autorotate__img.src='images/autorotate.png';
		}
		...
		this._info__img.setAttribute('src','images/info.png');
		...
		this._info.onmouseover=function () {
			me._info__img.src='images/info__o.png';
		}
		this._info.onmouseout=function () {
			me._info__img.src='images/info.png';
		}
		...
		this._movemode__img.setAttribute('src','images/movemode.png');
		...
		this._movemode.onmouseover=function () {
			me._movemode__img.src='images/movemode__o.png';
		}
		this._movemode.onmouseout=function () {
			me._movemode__img.src='images/movemode.png';
		}
		...
		this._fullscreen__img.setAttribute('src','images/fullscreen.png');
		...
		this._fullscreen.onmouseover=function () {
			me._fullscreen__img.src='images/fullscreen__o.png';
		}
		this._fullscreen.onmouseout=function () {
			me._fullscreen__img.src='images/fullscreen.png';
		}
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		
		{
			...
			this._hsimage__img.setAttribute('src','images/hsimage.png');
